...
["course1","course2","course3","course4","course5","course6","course7","course8","course9","course10","course11","course12","course13","course14","course15","course16"
                                                            ...
                                                            if(isConfirm){
                                                                            swal({
                                                                                  ...
                                                                                  dangerMode: true,
                                                                                                        ...
                                                                                                        if (isConfirm) {
                                                                                                                         swal({title: 'Submitted!',text: 'your courses 

are successfully submitted!',icon: 'success'})
                                                                                                                         .then(function() {
                                                                                                                                            // mention ur download file 
